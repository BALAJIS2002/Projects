...
<h3>Complaining Person's Details </h3>
  <div class="form-row">
    <div class="form-group col-md-6">   <input type="hidden" class="form-control" id="inputPassword4" name="email" value="<%=cemail %>" placeholder="Enter Email Address" required>
    </div>
  </div>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="zone" value="<%=zone %>" class="form-control" id="inputCity" required>
    </div>
   
    <div class="form-group col-md-4">
      <label for="inputZip">Compliant Address</label>
      <input type="text" name="add" value="<%=address %>" class="form-control" id="inputZip" required>
    </div>
...
<input type="text" name="type"  value="<%=depart %>" class="form-control"  id="inputCity" required>  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" name="type" value="<%=ctype %>" class="form-control" id="inputCity" required>
    </div>
    </div>
     <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputCity">Do you want government support... </label>
